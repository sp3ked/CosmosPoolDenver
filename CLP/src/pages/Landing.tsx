              ...
              <div className="text-center">
                ...
                <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
                  <div className="rounded-md shadow">
                    <a
                      href="#what-is-clmm"
                      className="w-full flex items-center justify-center px-8 py-3 border border-blue-900 text-base font-medium rounded-md text-white bg-blue-900/50 hover:bg-blue-800/60 md:py-4 md:text-lg md:px-10 transition-colors"
                    >
                      Learn More
                    </a>
                  </div>
                  <div className="mt-3 sm:mt-0 sm:ml-3">
                    <ImprovedShimmerButton to="/dashboard" size="xl" className="w-full">
                      Launch App
